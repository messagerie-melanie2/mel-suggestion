<template>
  <section class="flex justify-center relative">
    <img src="/bg.jpg" alt="gradient background image" class="w-full h-full object-cover fixed">
    <div class="mx-auto max-w-lg px-6 lg:px-8 absolute py-20">
      <div class="flex items-center justify-center lg:mb-11 mb-8">
        <img src="/favicon.ico" alt="Suggestion app logo" class="mr-5">
        <span class="text-gray-900 text-center font-manrope text-3xl font-bold leading-10">Suggestion</span>
      </div>
      <div class="rounded-2xl bg-white shadow-xl">
        <div action="" class="lg:p-11 p-7 mx-auto">
          <div class="mb-11">
            <h1 class="text-gray-900 text-center font-manrope text-3xl font-bold leading-10 mb-2">Bienvenue</h1>
            <p class="text-gray-500 text-center text-base font-medium leading-6">Choisir un mode de connexion</p>
          </div>
          <ul class="my-4 space-y-3 w-96">
            <li v-if="this.loginOperators.includes('google')">
              <button
                class="flex items-center p-3 font-bold border border-gray-200 text-slate-800 rounded-full hover:bg-gray-50 w-full"
                @click="login('google')">
            ...
            <li v-if="this.loginOperators.includes('microsoft')">
              <button
                class="flex items-center p-3 font-bold border border-gray-200 text-slate-800 rounded-full hover:bg-gray-50 w-full"
                ...
                <span class="ml-3">Microsoft</span>
              </button>
            </li>
            <li v-if="this.loginOperators.includes('linkedin')">
              <button
                class="flex items-center p-3 font-bold border border-gray-200 text-slate-800 rounded-full hover:bg-gray-50 w-full"
            ...
            <li v-if="this.loginOperators.includes('apple')">
              <button
                class="flex items-center p-3 font-bold border border-gray-200 text-slate-800 rounded-full hover:bg-gray-50 w-full"
                @click="login('apple')">
                <svg xmlns='http://www.w3.org/2000/svg' width='24px' height='24px' viewBox='0 0 256 315'
                  class="no-dark-svg">
                  <path
            ...
            <li v-if="this.loginOperators.includes('facebook')">
              <button
                class="flex items-center p-3 font-bold border border-gray-200 text-slate-800 rounded-full hover:bg-gray-50 w-full"
