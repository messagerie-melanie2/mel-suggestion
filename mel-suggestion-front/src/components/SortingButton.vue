  ...
  <div>
    <div class="inline-flex">
      <button class="bg-white text-slate-600 font-semibold py-2 px-3 border border-gray-300 rounded-l shadow"
        ...
        v-bind:class="[sortBy === 'nb_votes' && validateOnly === false ? 'bg-gray-200 hover:bg-gray-200': '', $darkTheme ? 'hover:bg-gray-800' : 'hover:bg-gray-100']">
      ...
      <button class="bg-white text-slate-600 font-semibold py-2 px-3 border border-gray-300 shadow"
        ...
        v-bind:class="[sortBy === 'updated_at' && validateOnly === false ? 'bg-gray-200 hover:bg-gray-200' : '', $darkTheme ? 'hover:bg-gray-800' : 'hover:bg-gray-100']">
      ...
      <button class="bg-white text-slate-600 font-semibold py-2 px-3 border border-gray-300 rounded-r shadow"
        @click="sort('updated_at', true)" v-bind:class="[validateOnly === true ? 'bg-gray-200 hover:bg-gray-200' : '', $darkTheme ? 'hover:bg-gray-800' : 'hover:bg-gray-100']">
